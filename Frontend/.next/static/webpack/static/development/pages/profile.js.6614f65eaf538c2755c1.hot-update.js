...
/* harmony import */ var react_notifications__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! react-notifications */ "./node_modules/react-notifications/lib/index.js");
/* harmony import */ var react_notifications__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(react_notifications__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _profile_css__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../profile.css */ "./profile.css");
  ...
  function Profile(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "handleChangeImageIploadChange", function (event) {
      ...
      img.onload = function () {
        ...
        if (this.width / this.height < 4 / 3) {
          react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("Image is not horizontal or almost squre");
        } else if (this.width / this.height > 3.5 / 2) {
          react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("Image is Panorama and can not be accepted");
        } else {
          ...
          if (w > 0) {
            ...
            __this.API.uploadImage(document.getElementById("inp_img").value, __this.state.id).then(function (res) {
              if (res.message === "File Uploaded.") {
                react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("Image uploading, You should save profile after it");
                ...
                react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].error("Unable to Upload This Image");
              }
            });
          }
        }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "handleUpdateCompany", function () {
      ...
      if (_this.state.validated === false) {
        react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].error("You Should Fill the Required Fields");

        _this.setState({
          toUpdateAlert: "Fill all required fields correctly."
        });
      } else if (_this.state.savedProfile === true) {
        react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("There is no change to be saved!");
      } else {
        ...
        _this.API.updateCompany(_this.state).then(function (res) {
          react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("Your profile is updated");
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "handleAddCompany", function () {
      ...
      if (_this.state.validated === false) {
        ...
        _this.API.addCompany(_this.state).then(function (res) {
          react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("You profile is created");
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Profile, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
        ...
        __self: this
      }, "\u043F\u043E\u043D\u043F\u043E\u043D"), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(Link, {
        to: "/profile",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 158
        ...
        __self: this
      }, "Acount and Profile "), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(Link, {
        to: "/Service",
        onClick: function onClick(e) {
          if (_this3.state.savedProfile === false || _this3.state.newUser) {
            e.preventDefault();
            react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("Save your profile first");
          ...
          if (_this3.state.imagesurl[0] === "") {
            e.preventDefault();
            react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("You should have at least one image to add service");
          }
        },
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "Services and Discounts"), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(Link, {
        to: "/report",
        onClick: function onClick(e) {
        ...
        __self: this
      }, "Reports and Messages"), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(Link, {
        to: "#Signout",
        className: "topright",
        ...
        __self: this
      }, "\u0441\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C"))), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationContainer"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 623
        },
    ...
    value: function handleChangeCompany(event) {
      ...
      if (event.target.value.length < 2) react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("Provide a full name include company type");
      this.setState({
    ...
    value: function handleChangeDescription(event) {
      ...
      if (event.target.value.length < 2) react_notifications__WEBPACK_IMPORTED_MODULE_14__["NotificationManager"].info("Describe company includeing type of services that it provides");
      this.setState({
...
//# sourceMappingURL=profile.js.6614f65eaf538c2755c1.hot-update.js.map